...
export default function AddGroup(props) {
  ...
  function addGroup(group) {
    return axios.post(`http://localhost:8001/groups`, group)
      .then((response) => {
  ...
  return (
    ...
    <div className="add-tool-button-div">
      ...
      <button type="button"
        className="button-add" data-toggle="modal" data-target={`#newgroupmodal${groups.group_id}`}>Add group
      </button>

      {/* <!-- Modal --> */}
      <div className="modal fade" id={`newgroupmodal${groups.group_id}`} tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              ...
              <h5 className="modal-title" id="exampleModalLabel">Add a new group</h5>
            ...
            <div className="modal-body">
              ...
              <label className="add_tool_title" htmlFor="title">Icon</label>
              <input className="form-control-add"
                type="text"
                name="title"
                value={group_icon}
